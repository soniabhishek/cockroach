...
//	ID          uuid.UUID      `db:"id" json:"id" bson:"_id"`
//	ReferenceId sql.NullString `db:"reference_id" json:"reference_id" bson:"reference_id"`
...
//}
//
//type InputFluValidator struct {
//	ID          uuid.UUID    `db:"id" json:"id" bson:"_id"`
//	FieldName   string       `db:"field_name" json:"field_name" bson:"field_name"`
//	Type        string       `db:"type" json:"type" bson:"type"`
//	IsMandatory sql.NullBool `db:"is_mandatory" json:"is_mandatory" bson:"is_mandatory"`
//	MacroTaskId uuid.UUID    `db:"macro_task_id" json:"macro_task_id" bson:"macro_task_id"`
...
//
//const (
//	HappinessHappy     = "happy"
//	HappinessVeryHappy = "very happy"
//	HappinessEcstatic  = "ecstatic"
//)
