...
func (*stepConfigSvcMock) GetAlgorithmStepConfig(stepId uuid.UUID) (models.AlgorithmConfig, error) {
	panic("implement me")
}

func (*stepConfigSvcMock) GetCrowdsourcingStepConfig(stepId uuid.UUID) (models.CrowdsourcingConfig, error) {
	panic("implement me")
}
