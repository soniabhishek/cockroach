...
import (
	...
	"github.com/crowdflux/angel/app/services/work_flow_svc/step/logic_gate_step_svc"
...
func (sr *stepRouter) connectAll() {
	...
	var logicGateStepConn IConnector = logic_gate_step_svc.StdLogicGateStep
	...
	sr.routeTable = routeTable{
		...
		step_type.LogicGate:        logicGateStepConn.Connect(&sr.InQ),
